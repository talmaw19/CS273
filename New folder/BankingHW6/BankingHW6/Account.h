...
protected:
	...
	std::string get_fees()
	{
		...
		overdraft = this->customer->getOverdraftPenatly();
		charge = this->customer->getCheckCharge();
		std::stringstream ss;
...
protected:
	...
	*/
	void add_interest(double interest) {
		...
		tran = new Transaction(this->customer->getCustomersNum(), "Add intrest", amt, fees);
...
public:
	...
	*/
	virtual std::string to_string() {
		...
		ss << " Name: " << this->customer->getName() << std::endl;
		ss << " Age: " << this->customer->getAge() << std::endl;
		ss << " Address: " << this->customer->getAdress() << std::endl;
		ss << " Phone Number: " << this->customer->getTelephoneNum() << std::endl;
		ss << " Customers Identification Number " << this->customer->getCustomersNum() << std::endl;
	...
	*/
	virtual void deposit(double amt) {
		...
		tran = new Transaction(this->get_customer()->getCustomersNum(), "Deposit amount", amt, fees);
		transactions.push_back(tran);
	}
	...
	*/
	virtual void withdraw(double amt) {
		...
		tran = new Transaction(this->get_customer()->getCustomersNum(), "Withdraw", amt, fees);
		transactions.push_back(tran);
	}
...
public:
	...
	std::string to_string() {
		...
		ss << " Phone Number: " << this->customer->getTelephoneNum() << std::endl;
		ss << " Customers Identification Number " << this->customer->getCustomersNum() << std::endl;
		ss << " Saving Intrest: " << this->customer->getCustomersNum() << std::endl;
		ss << "  Balance: " << balance << std::endl;
		ss << "  Account ID: " << account_number << std::endl;
	...
	void add_interest()
	{
		balance = balance*this->get_customer()->getSavingInterest();
	}
};
...
{
public:
	Checking_Account(Customer *cust, int account_id) : Account(cust, account_id)
	{
		this->customer = cust;
		this->account_number = account_number;
		balance = 0;
	...
	std::string to_string() {
		...
		ss << " Phone Number: " << this->customer->getTelephoneNum() << std::endl;
		ss << " Customers Identification Number " << this->customer->getCustomersNum() << std::endl;
		ss << "Checking Interest: " << this->customer->getCheckIntrest() << std::endl;
		ss << "  Balance: " << balance << std::endl;
		ss << "  Account ID: " << account_number << std::endl;
		return ss.str();
	}
