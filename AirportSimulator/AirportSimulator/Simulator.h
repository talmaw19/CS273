...
public:
	...
	void show_stats()
	{
		...
		double averageLanding;
	averageLanding = landing_queue->get_total_wait() / landing_queue->get_num_served();
		...
		double averageDeparture;
		averageDeparture = departure_queue->get_total_wait() / departure_queue->get_num_served();
