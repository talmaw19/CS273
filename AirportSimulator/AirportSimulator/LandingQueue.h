...
public:
	...
	void update(int clock)
	{
		...
		*/
		// the arrival rate is the rate on when passangers will arrive. 
		// if the arival rate is .75 that means that on average .75 passangers will arrive every minute or 3 passangers in 4 minutes 
